...
function helpWindow() {
	...
	content += '<p><i>Projection Wizard</i> is a web application that helps cartographers select an appropriate projection for their map. Depending on the extent and the distortion property of the map, the application returns a list of appropriate map projections with additional projection parameters if necessary. The <i>Projection Wizard</i> is based on John P. Snyder’s selection guideline and on the extension to this guideline for world and hemisphere maps written by the <a target="_top" href="http://cartography.oregonstate.edu/">Cartography and Geovisualization Group</a> at Oregon State University.</p>';
	...
	content += '<h3>Additional Notes and Tips</h3>';
	...
	content += '<p class="outputText"><b>Map Projection Selection Tool</b> (June, 2013)</p><ul class="outputText">';
	...
	content += '<p class="outputText"><br><b>Projection Wizard</b> (December, 2015)</p><ul class="dialogtext">';
	content += '<li>The Patterson projection is added to a list of compromise world map projections.</li>';
	content += '<li>The help content is updated.</li></ul>';
