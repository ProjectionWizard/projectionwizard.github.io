...
L.Edit.Rectangle = L.Edit.SimpleShape.extend({
	...
	_bindMarker: function (marker) {
		L.Edit.SimpleShape.prototype._bindMarker.call(this, marker);
		...
		marker.on('mouseover', function(e) {
			...
			var MYmarkers = $(".leaflet-div-icon");
			MYmarkers.removeClass('leaflet-div-icon').addClass('leaflet-div-newicon');
		});
		...
		marker.on("mouseout", function(e) {
			...
			//changing the markers
			var MYmarkers = $(".leaflet-div-newicon");
			MYmarkers.removeClass('leaflet-div-newicon').addClass('leaflet-div-icon');
